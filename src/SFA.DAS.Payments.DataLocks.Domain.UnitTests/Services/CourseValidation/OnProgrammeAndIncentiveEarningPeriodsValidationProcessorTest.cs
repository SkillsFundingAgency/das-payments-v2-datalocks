    ...
    public class OnProgrammeAndIncentiveEarningPeriodsValidationProcessorTest
    {
        ...
        public void SetUp()
        {
            mocker = AutoMock.GetLoose(cfg =>
            {
                ...
                cfg.RegisterInstance(new OnProgrammeAndIncentiveStoppedValidator(new CalculatePeriodStartAndEndDate()).As<IOnProgrammeAndIncentiveStoppedValidator>());
                cfg.RegisterInstance(new CompletionStoppedValidator().As<ICompletionStoppedValidator>());
